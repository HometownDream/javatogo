...
![image-20200721083711830](https://cdn.jsdelivr.net/gh/HometownDream/blogImage@main/imgJavaToGo202212221435225.png)
...
![image-20200721084549011](https://cdn.jsdelivr.net/gh/HometownDream/blogImage@main/imgJavaToGo202212221435226.png)
...
本节开始的示例代码中  var a *int 只是声明了一个指针变量a但是没有初始化，指针作为引用类型需要初始化后才会拥有内存空间，才可以给它赋值。
